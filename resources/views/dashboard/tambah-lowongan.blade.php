...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="brand">
            <a href="#"><img src="{{ asset('storage\logo-dashboard-smkn2.png')}}" alt="SMKN 2 Logo"
                                ...
                                <form action="{{ route('lowongan.store') }}" method="post"
                                    ...
                                    <div class="mb-3 {{ $errors->has('judul') ? 'has-error' : '' }}">
                                        ...
                                        <input name="judul" type="text" class="form-control" id="InputJudul"
                                            placeholder="Contoh: LOWONGAN KERJA PT ABCD" value="{{ old('judul') }}">
                                        @if ($errors->has('judul'))
                                    ...
                                    <div class="mb-3" {{ $errors->has('perusahaan') ? 'has-error' : '' }}>
                                        ...
                                        <input name="perusahaan" type="text" class="form-control"
                                            id="InputPerusahaan" placeholder="Contoh: PT ABCD"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Tentang Lowongan" id="InputDeskripsi"
                                    ...
                                    <div class="mb-3" {{ $errors->has('penempatan') ? 'has-error' : '' }}>
                                        ...
                                        <input name="penempatan" type="text" class="form-control"
                                            id="InputPenempatan" placeholder="Contoh: Bangkalan/Surabaya/Jakarta"
                                    ...
                                    <div class="mb-3" {{ $errors->has('gaji') ? 'has-error' : '' }}>
                                        ...
                                        <input name="gaji" type="text" class="form-control" id="InputGaji"
                                            placeholder="Contoh: 2000000" value="{{ old('gaji') }}">
                                        @if ($errors->has('gaji'))
