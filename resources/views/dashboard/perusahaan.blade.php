                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <div class="right">
                                    <a href="/dashboard/perusahaan/tambah" class="btn btn-primary"><i
                                            class="fa fa-plus"></i> Tambah Data</a>
                                </div>
                            </div>
                            <div class="panel-body">
                                <form action="/dashboard/perusahaan" method="get">
                                    <div class="input-group">
                                        <input name="cari" class="form-control" type="text"
                                            placeholder="Cari data perusahaan" value="{{ request('cari') }}">
                                                ...
                                                <td>
                                                    <a href="/dashboard/perusahaan/edit/{{ $comp->id }}"
                                                        class="btn btn-warning"><i class="fa fa-pencil"
                                                            title="Edit Data"></i></a>
                                                    <form action="{{ route('perusahaan.destroy', $comp->id) }}"
