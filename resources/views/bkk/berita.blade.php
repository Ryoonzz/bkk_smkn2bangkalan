    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .berita {
                flex-direction: column;
                /* Biar gambar & teks jadi satu kolom */
                text-align: center;
            ...
            .berita-img {
                max-width: 100%;
                /* Gambar jadi full width */
                margin-bottom: 10px;
                /* Kasih jarak bawah biar rapi */
            }

            .judul-berita {
                font-size: 16px;
                /* Biar gak terlalu besar di layar kecil */
            }
        ...
        <div class="container">
            @foreach ($berita as $item)
                <div class="row berita">
                    <div class="col-md-3">
                        <img src="{{ asset($item->gambar) }}" class="img-thumbnail berita-img"
                            alt="{{ $item->judul }}">
                    </div>
                    <div class="col-md-9">
                        <h4 class="judul-berita"><a href="{{ route('berita.show', $item->id) }}">{{ $item->judul }}</a>
                        </h4>
                        <p class="tanggal-berita">{{ \Carbon\Carbon::parse($item->tanggal)->format('F d, Y') }}</p>
                        <p class="isi-berita">
                            {{-- {!! nl2br(e($item->deskripsi)) !!} --}}
                            {{ Str::limit($item->deskripsi, 350, '...') }}
                        </p>
                    </div>
                </div>
                <hr>
